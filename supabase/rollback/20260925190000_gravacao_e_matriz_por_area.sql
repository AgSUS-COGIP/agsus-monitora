/*
  ROLLBACK de migrations/20260925190000_gravacao_e_matriz_por_area.sql
  Devolve as 11 RPCs à definição lida do banco em 25/09/2026 e remove as guardas.
*/
begin;
...
drop function private."FC_EXIGIR_AREA_SALVAR_EDITAL"(jsonb);
drop function private."FC_EXIGIR_AREA_EDITAL"(text);
